...
#####################################################################################################################################################
############################################Aces paper ideas 12/4/17 #################################

####ADDDING IN SCORING

################################ Anxiety Sensitivity Index (ASI) #####################################
#remove long title and subset
ASIdf <- data[,grepl("Anxiety",names(data))]
...
#remove long title and subset
ASQdf <- data[,grepl("Attachment.Style.QuestionnaireÂ.Experiences.in.Close.Relationships..R..Â..The.statements.below.conc....",names(data))]
...
Scores <-subset(data, select = c("ACESscore", "QIDS", "ASIScore", "AttachmentAnxietyScore", "AttachmentAvoidScore", "PANASpostOM_ClosenessToOthers", "PANASpreOM_ClosenessToOthers"))
